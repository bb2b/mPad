    ...
    n_current_page(0)
{
    ...
    m_open_on_desktop_btn = new QPushButton(this);
    m_previous_page_left_btn = new QPushButton(this);
    m_previous_page_right_btn = new QPushButton(this);
    m_previous_page_left_btn->setEnabled(false);
    m_previous_page_right_btn->setEnabled(false);
    m_next_page_left_btn = new QPushButton(this);
    m_next_page_right_btn = new QPushButton(this);
...
void ExplorerWindow::mouseDoubleClickEvent(QMouseEvent *event)
{
    ...
    this->setGeometry(GetSystemMetrics(SM_CXSCREEN)/4,0,GetSystemMetrics(SM_CXSCREEN)/2,GetSystemMetrics(SM_CYSCREEN));
}
...
void ExplorerWindow::resizeEvent(QResizeEvent *event)
{
    ...
    m_open_on_desktop_btn->setGeometry(w-60,0,60,20);
    m_max_btn->setGeometry(w-m_open_on_desktop_btn->width()-5-40,0,40,20);
    m_previous_page_left_btn->setGeometry(0,h/3,40,20);
    m_previous_page_right_btn->setGeometry(w-40,h/3,40,20);
    m_next_page_left_btn->setGeometry(0,h*2/3,40,20);
    m_next_page_right_btn->setGeometry(w-40,h*2/3,40,20);
    m_display->setGeometry(40,20,w-40*2,h-20);
